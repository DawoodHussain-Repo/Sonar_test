...
public class CustomerRoom extends JFrame {
	...
	public AbstractButton btnGenerateReceipt;
	...
	public JComboBox comboBox_Dish = new JComboBox();
	public JComboBox comboBox_Drink = new JComboBox();
	private JTable table;
	private JTable table_1;
	public JTextArea area = new JTextArea();
	public JTextField totalA;
	public JLabel a1 = new JLabel("*");
	public JLabel a2 = new JLabel("*");
	public JLabel a3 = new JLabel("*");
